...
def main() -> None:
    ...
    common_achievements = alice_achievements.intersection(bob_achievements, charlie_achievements, dylan_achievements)
    all_achievements = alice_achievements.union(bob_achievements, charlie_achievements, dylan_achievements)
